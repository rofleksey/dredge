...
function parseClientNoticeBody(body: unknown): { severity: 'error' | 'warning'; message: string } | null {
...
export function notifyFromApiError(
  err: unknown,
  opts: { id?: string; title: string; fallbackDescription: string },
): void {
